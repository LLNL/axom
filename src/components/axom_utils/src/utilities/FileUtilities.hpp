...
/*!
 * \brief Helper function to print out the current working directory within the
 *file system
 ...
 * \param [in] fileName string name of a file (possibly including relative or
 *absolute path)
...
/*!
 * \brief Joins a file directory fileDir and a file name fileName with the given
 *separator char
 ...
 * \param [in] separator The path separator for the file system.  Should be a
 *single character
