 ...
 * It uses the Curiously recurring template pattern: The first template parameter
 * should be the actual iterator class. \n
 * e.g.
 * \code{.cpp}
 * class IteratorOfSomeClass : public IteratorBase < IteratorOfSomeClass, double >
 * { ... };
 * \endcode
 *
