...
//
{
  ...
  {
    cout << "  " << std::setw(6) << ( face + offset );
    for ( vertex = 0; vertex < 3; vertex++ )
    {
      cout << "  " << std::setw(6) << face_node[vertex+face*3];
    }
    cout << "\n";
  }
...
//
{
  ...
  for ( face = 0; face < face_num; face++ )
  {
    cout << "  " << std::setw(6) << face;
    for ( i = 0; i < 3; i++ )
    {
      cout << "  " << std::setw(14) << face_normal[i+face*3];
    }
    cout << "\n";
  }
...
//
{
  ...
  {
    cout << "  " << std::setw(6) << node;
    for ( i = 0; i < 3; i++ )
    {
      cout << "  " << std::setw(14) << node_xyz[i+node*3];
    }
    cout << "\n";
  }
...
//
  ...
  for ( face = 0; face < face_num; face++ )
  {
    ...
    for ( i = 0; i < 3; i++ )
    {
      output_unit << "  " << std::setw(10) << face_normal[i+face*3];
    }
    output_unit << "\n";
    ...
    for ( vertex = 0; vertex < 3; vertex++ )
    {
      ...
      for ( i = 0; i < 3; i++ )
      {
        output_unit << "  " << std::setw(10) << node_xyz[i+node*3];
      }
      output_unit << "\n";
    }
