...
void QUEST_signed_distance_set_geometry(int type)
{
// splicer begin function.signed_distance_set_geometry
    axom::quest::signed_distance_set_geometry(type);
    return;
// splicer end function.signed_distance_set_geometry
}
