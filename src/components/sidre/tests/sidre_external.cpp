...
TEST(sidre_external, verify_external_layout)
{
  ...
  SLIC_INFO("Tests that the hierarchy generated by DataGroup::"
  ...
  root->createViewAndAllocate("int/desc/bufferview", asctoolkit::sidre::INT_ID, SZ);
  ...
  root->createView("ext/desc/external_desc", asctoolkit::sidre::INT_ID, SZ, extData);
