...
int main(void)
{
  ...
  int * const currCycle = problem->getView("cycle")->getValue();

  int numTotalCycles = problem->getView("numTotalCycles")->getValue();
  int dumpInterval = problem->getView("numCyclesPerDump")->getValue();
