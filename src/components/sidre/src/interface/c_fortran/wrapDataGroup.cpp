...
void SIDRE_datagroup_get_name_bufferify(const SIDRE_datagroup * self, char * SH_F_rv, int LSH_F_rv)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
bool SIDRE_datagroup_has_view_bufferify(const SIDRE_datagroup * self, const char * path, int Lpath)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
bool SIDRE_datagroup_has_child_view(const SIDRE_datagroup * self, const char * name)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
bool SIDRE_datagroup_has_child_view_bufferify(const SIDRE_datagroup * self, const char * name, int Lname)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
bool SIDRE_datagroup_rename_bufferify(SIDRE_datagroup * self, const char * new_name, int Lnew_name)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_get_view_from_name(SIDRE_datagroup * self, const char * path)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_get_view_from_name_bufferify(SIDRE_datagroup * self, const char * path, int Lpath)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_IndexType SIDRE_datagroup_get_view_index(const SIDRE_datagroup * self, const char * name)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
SIDRE_IndexType SIDRE_datagroup_get_view_index_bufferify(const SIDRE_datagroup * self, const char * name, int Lname)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
void SIDRE_datagroup_get_view_name_bufferify(const SIDRE_datagroup * self, SIDRE_IndexType idx, char * SH_F_rv, int LSH_F_rv)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
SIDRE_IndexType SIDRE_datagroup_get_first_valid_view_index(const SIDRE_datagroup * self)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
SIDRE_IndexType SIDRE_datagroup_get_next_valid_view_index(const SIDRE_datagroup * self, SIDRE_IndexType idx)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_and_allocate_nelems(SIDRE_datagroup * self, const char * path, int type, SIDRE_SidreLength num_elems)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
// splicer begin class.DataGroup.method.create_view_and_allocate_nelems
    const std::string SH_path(path);
    DataView * rv = selfobj->createViewAndAllocate(SH_path, getTypeID(type), num_elems);
    return static_cast<SIDRE_dataview *>(static_cast<void *>(rv));
// splicer end class.DataGroup.method.create_view_and_allocate_nelems
}

SIDRE_dataview * SIDRE_datagroup_create_view_and_allocate_nelems_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, int type, SIDRE_SidreLength num_elems)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_and_allocate_shape(SIDRE_datagroup * self, const char * path, int type, int ndims, SIDRE_SidreLength * shape)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
// splicer begin class.DataGroup.method.create_view_and_allocate_shape
    const std::string SH_path(path);
    DataView * rv = selfobj->createViewAndAllocate(SH_path, getTypeID(type), ndims, shape);
    return static_cast<SIDRE_dataview *>(static_cast<void *>(rv));
// splicer end class.DataGroup.method.create_view_and_allocate_shape
}

SIDRE_dataview * SIDRE_datagroup_create_view_and_allocate_shape_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, int type, int ndims, SIDRE_SidreLength * shape)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_scalar_int(SIDRE_datagroup * self, const char * path, int value)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_scalar_int_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, int value)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_scalar_long(SIDRE_datagroup * self, const char * path, long value)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_scalar_long_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, long value)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_scalar_float(SIDRE_datagroup * self, const char * path, float value)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_scalar_float_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, float value)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_scalar_double(SIDRE_datagroup * self, const char * path, double value)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_scalar_double_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, double value)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_string(SIDRE_datagroup * self, const char * path, const char * value)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_string_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, const char * value, int Lvalue)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_empty(SIDRE_datagroup * self, const char * path)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_empty_bufferify(SIDRE_datagroup * self, const char * path, int Lpath)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_from_type(SIDRE_datagroup * self, const char * path, int type, SIDRE_SidreLength num_elems)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_from_type_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, int type, SIDRE_SidreLength num_elems)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_from_type_and_buffer(SIDRE_datagroup * self, const char * path, int type, SIDRE_SidreLength num_elems, SIDRE_databuffer * buff)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
// splicer begin class.DataGroup.method.create_view_from_type_and_buffer
    const std::string SH_path(path);
    DataView * rv = selfobj->createView(SH_path, getTypeID(type), num_elems, static_cast<DataBuffer *>(static_cast<void *>(buff)));
    return static_cast<SIDRE_dataview *>(static_cast<void *>(rv));
// splicer end class.DataGroup.method.create_view_from_type_and_buffer
}

SIDRE_dataview * SIDRE_datagroup_create_view_from_type_and_buffer_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, int type, SIDRE_SidreLength num_elems, SIDRE_databuffer * buff)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_from_type_external(SIDRE_datagroup * self, const char * path, int type, SIDRE_SidreLength num_elems, void * external_ptr)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
// splicer begin class.DataGroup.method.create_view_from_type_external
    const std::string SH_path(path);
    DataView * rv = selfobj->createView(SH_path, getTypeID(type), num_elems, external_ptr);
    return static_cast<SIDRE_dataview *>(static_cast<void *>(rv));
// splicer end class.DataGroup.method.create_view_from_type_external
}

SIDRE_dataview * SIDRE_datagroup_create_view_from_type_external_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, int type, SIDRE_SidreLength num_elems, void * external_ptr)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_from_shape(SIDRE_datagroup * self, const char * path, int type, int ndims, SIDRE_SidreLength * shape)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_from_shape_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, int type, int ndims, SIDRE_SidreLength * shape)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_from_shape_and_buffer(SIDRE_datagroup * self, const char * path, int type, int ndims, SIDRE_SidreLength * shape, SIDRE_databuffer * buff)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
// splicer begin class.DataGroup.method.create_view_from_shape_and_buffer
    const std::string SH_path(path);
    DataView * rv = selfobj->createView(SH_path, getTypeID(type), ndims, shape, static_cast<DataBuffer *>(static_cast<void *>(buff)));
    return static_cast<SIDRE_dataview *>(static_cast<void *>(rv));
// splicer end class.DataGroup.method.create_view_from_shape_and_buffer
}

SIDRE_dataview * SIDRE_datagroup_create_view_from_shape_and_buffer_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, int type, int ndims, SIDRE_SidreLength * shape, SIDRE_databuffer * buff)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_from_shape_external(SIDRE_datagroup * self, const char * path, int type, int ndims, SIDRE_SidreLength * shape, void * external_ptr)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
// splicer begin class.DataGroup.method.create_view_from_shape_external
    const std::string SH_path(path);
    DataView * rv = selfobj->createView(SH_path, getTypeID(type), ndims, shape, external_ptr);
    return static_cast<SIDRE_dataview *>(static_cast<void *>(rv));
// splicer end class.DataGroup.method.create_view_from_shape_external
}

SIDRE_dataview * SIDRE_datagroup_create_view_from_shape_external_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, int type, int ndims, SIDRE_SidreLength * shape, void * external_ptr)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_into_buffer(SIDRE_datagroup * self, const char * path, SIDRE_databuffer * buff)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
// splicer begin class.DataGroup.method.create_view_into_buffer
    const std::string SH_path(path);
    DataView * rv = selfobj->createView(SH_path, static_cast<DataBuffer *>(static_cast<void *>(buff)));
    return static_cast<SIDRE_dataview *>(static_cast<void *>(rv));
// splicer end class.DataGroup.method.create_view_into_buffer
}

SIDRE_dataview * SIDRE_datagroup_create_view_into_buffer_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, SIDRE_databuffer * buff)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_external(SIDRE_datagroup * self, const char * path, void * external_ptr)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_dataview * SIDRE_datagroup_create_view_external_bufferify(SIDRE_datagroup * self, const char * path, int Lpath, void * external_ptr)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
void SIDRE_datagroup_destroy_view_bufferify(SIDRE_datagroup * self, const char * path, int Lpath)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
void SIDRE_datagroup_destroy_view_and_data_name(SIDRE_datagroup * self, const char * path)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
void SIDRE_datagroup_destroy_view_and_data_name_bufferify(SIDRE_datagroup * self, const char * path, int Lpath)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
bool SIDRE_datagroup_has_group_bufferify(SIDRE_datagroup * self, const char * path, int Lpath)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
bool SIDRE_datagroup_has_child_group_bufferify(SIDRE_datagroup * self, const char * name, int Lname)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_datagroup * SIDRE_datagroup_get_group(SIDRE_datagroup * self, const char * path)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_datagroup * SIDRE_datagroup_get_group_bufferify(SIDRE_datagroup * self, const char * path, int Lpath)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_IndexType SIDRE_datagroup_get_group_index(const SIDRE_datagroup * self, const char * name)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
SIDRE_IndexType SIDRE_datagroup_get_group_index_bufferify(const SIDRE_datagroup * self, const char * name, int Lname)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
void SIDRE_datagroup_get_group_name_bufferify(const SIDRE_datagroup * self, SIDRE_IndexType idx, char * SH_F_rv, int LSH_F_rv)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
SIDRE_IndexType SIDRE_datagroup_get_first_valid_group_index(const SIDRE_datagroup * self)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
SIDRE_IndexType SIDRE_datagroup_get_next_valid_group_index(const SIDRE_datagroup * self, SIDRE_IndexType idx)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
SIDRE_datagroup * SIDRE_datagroup_create_group(SIDRE_datagroup * self, const char * path)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
SIDRE_datagroup * SIDRE_datagroup_create_group_bufferify(SIDRE_datagroup * self, const char * path, int Lpath)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
void SIDRE_datagroup_destroy_group_name(SIDRE_datagroup * self, const char * path)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
void SIDRE_datagroup_destroy_group_name_bufferify(SIDRE_datagroup * self, const char * path, int Lpath)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
bool SIDRE_datagroup_is_equivalent_to(const SIDRE_datagroup * self, const SIDRE_datagroup * other)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
// splicer begin class.DataGroup.method.is_equivalent_to
    bool rv = selfobj->isEquivalentTo(static_cast<const DataGroup *>(static_cast<const void *>(other)));
    return rv;
// splicer end class.DataGroup.method.is_equivalent_to
}

void SIDRE_datagroup_save(const SIDRE_datagroup * self, const char * file_path, const char * protocol)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
void SIDRE_datagroup_save_bufferify(const SIDRE_datagroup * self, const char * file_path, int Lfile_path, const char * protocol, int Lprotocol)
{
const DataGroup *selfobj = static_cast<const DataGroup *>(static_cast<const void *>(self));
...
void SIDRE_datagroup_load(SIDRE_datagroup * self, const char * file_path, const char * protocol)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
void SIDRE_datagroup_load_bufferify(SIDRE_datagroup * self, const char * file_path, int Lfile_path, const char * protocol, int Lprotocol)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
void SIDRE_datagroup_load_external_data(SIDRE_datagroup * self, const char * file_path)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
...
void SIDRE_datagroup_load_external_data_bufferify(SIDRE_datagroup * self, const char * file_path, int Lfile_path)
{
DataGroup *selfobj = static_cast<DataGroup *>(static_cast<void *>(self));
