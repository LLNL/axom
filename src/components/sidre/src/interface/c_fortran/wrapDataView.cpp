...
// splicer begin class.DataView.method.attach_buffer_type
    selfobj->attachBuffer(getTypeID(type), num_elems, static_cast<DataBuffer *>(static_cast<void *>(buff)));
    return;
...
// splicer begin class.DataView.method.attach_buffer_shape
    selfobj->attachBuffer(getTypeID(type), ndims, shape, static_cast<DataBuffer *>(static_cast<void *>(buff)));
    return;
