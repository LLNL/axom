...
end subroutine datagroup_create_allocatable_view_{typename}_{nd}""".format(**d)
...
function datagroup_create_allocatable_view_{typename}_{nd}(group, name, value) result(rv)
    ...
    interface
       function ATK_create_allocatable_view_{typename}_{nd}(group, name, lname, array, itype, rank) result(rv)
       use iso_c_binding
       type(C_PTR), value, intent(IN)    :: group
       character(*), intent(IN)          :: name
       integer(C_INT), value, intent(IN) :: lname
       ...
       type(C_PTR) rv
       end function ATK_create_allocatable_view_{typename}_{nd}
    end interface
    ...
    lname = len_trim(name)
    rv%voidptr = ATK_create_allocatable_view_{typename}_{nd}(group%voidptr, name, lname, value, itype, rank)
end function datagroup_create_allocatable_view_{typename}_{nd}""".format(**d)
...
function datagroup_create_allocatable_view_{typename}_{nd}(group, name, value) result(rv)
    ...
    rv%voidptr = ATK_create_allocatable_view_{typename}_{nd}(group%voidptr, name, lname, value, itype, rank)
        ...
        raise RuntimeError("rank too large in print_create_allocatable_view")
