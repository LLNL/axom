...
subroutine dataview_get_value_{typename}_{nd}_ptr(view, value)
    use iso_c_binding
    implicit none
...
end subroutine dataview_get_value_{typename}_{nd}_ptr""".format(**d)
...
def type_bound_procedure_part(d):
    return 'procedure :: get_value_{typename}_{nd}_ptr => dataview_get_value_{typename}_{nd}_ptr'.format(**d)

def type_bound_procedure_generic(d):
    return 'get_value_{typename}_{nd}_ptr'.format(**d)
