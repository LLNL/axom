...
function datagroup_register_static_{typename}_{nd}(group, name, value) result(rv)
    ...
    interface
       function ATK_register_static_{typename}_{nd}(group, name, lname, array, indx) result(rv)
       use iso_c_binding
       type(C_PTR), value, intent(IN)    :: group
       character(*), intent(IN)          :: name
       integer(C_INT), value, intent(IN) :: lname
       {f_type},              intent(IN) :: array{shape}
       integer(C_INT), value, intent(IN) :: indx
       type(C_PTR) rv
       end function ATK_register_static_{typename}_{nd}
    end interface

    class(datagroup), intent(IN) :: group
    character(*), intent(IN) :: name
    {f_type}, intent(IN) :: value{shape}
    integer(C_INT) :: lname
    type(dataview) :: rv
    integer(C_INT) :: indx = {index}

    lname = len_trim(name)
!    rv%voidptr = ATK_register_static_{typename}_{nd}(group%voidptr, name, lname, value, indx)
end function datagroup_register_static_{typename}_{nd}""".format(**d)
