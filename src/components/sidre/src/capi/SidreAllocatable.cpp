...
extern "C" {
//[[[cog
//gen.print_lines(cog.outl, gen.print_sidre_size_allocatable_header)
//]]]
#define SIZE_ALLOCATABLE_INT_SCALAR FC_GLOBAL(sidre_size_allocatable_int_scalar,SIDRE_SIZE_ALLOCATABLE_INT_SCALAR)
size_t SIZE_ALLOCATABLE_INT_SCALAR(void * array);

#define SIZE_ALLOCATABLE_INT_1D FC_GLOBAL(sidre_size_allocatable_int_1d,SIDRE_SIZE_ALLOCATABLE_INT_1D)
size_t SIZE_ALLOCATABLE_INT_1D(void * array);

#define SIZE_ALLOCATABLE_LONG_SCALAR FC_GLOBAL(sidre_size_allocatable_long_scalar,SIDRE_SIZE_ALLOCATABLE_LONG_SCALAR)
size_t SIZE_ALLOCATABLE_LONG_SCALAR(void * array);

#define SIZE_ALLOCATABLE_LONG_1D FC_GLOBAL(sidre_size_allocatable_long_1d,SIDRE_SIZE_ALLOCATABLE_LONG_1D)
size_t SIZE_ALLOCATABLE_LONG_1D(void * array);

#define SIZE_ALLOCATABLE_FLOAT_SCALAR FC_GLOBAL(sidre_size_allocatable_float_scalar,SIDRE_SIZE_ALLOCATABLE_FLOAT_SCALAR)
size_t SIZE_ALLOCATABLE_FLOAT_SCALAR(void * array);

#define SIZE_ALLOCATABLE_FLOAT_1D FC_GLOBAL(sidre_size_allocatable_float_1d,SIDRE_SIZE_ALLOCATABLE_FLOAT_1D)
size_t SIZE_ALLOCATABLE_FLOAT_1D(void * array);

#define SIZE_ALLOCATABLE_DOUBLE_SCALAR FC_GLOBAL(sidre_size_allocatable_double_scalar,SIDRE_SIZE_ALLOCATABLE_DOUBLE_SCALAR)
size_t SIZE_ALLOCATABLE_DOUBLE_SCALAR(void * array);

#define SIZE_ALLOCATABLE_DOUBLE_1D FC_GLOBAL(sidre_size_allocatable_double_1d,SIDRE_SIZE_ALLOCATABLE_DOUBLE_1D)
size_t SIZE_ALLOCATABLE_DOUBLE_1D(void * array);

//[[[end]]]

//[[[cog
//gen.print_lines(cog.outl, gen.print_sidre_address_allocatable_header)
//]]]
#define ADDRESS_ALLOCATABLE_INT_SCALAR FC_GLOBAL(sidre_address_allocatable_int_scalar,SIDRE_ADDRESS_ALLOCATABLE_INT_SCALAR)
void ADDRESS_ALLOCATABLE_INT_SCALAR(void * array, void * * addr);

#define ADDRESS_ALLOCATABLE_INT_1D FC_GLOBAL(sidre_address_allocatable_int_1d,SIDRE_ADDRESS_ALLOCATABLE_INT_1D)
void ADDRESS_ALLOCATABLE_INT_1D(void * array, void * * addr);

#define ADDRESS_ALLOCATABLE_LONG_SCALAR FC_GLOBAL(sidre_address_allocatable_long_scalar,SIDRE_ADDRESS_ALLOCATABLE_LONG_SCALAR)
void ADDRESS_ALLOCATABLE_LONG_SCALAR(void * array, void * * addr);

#define ADDRESS_ALLOCATABLE_LONG_1D FC_GLOBAL(sidre_address_allocatable_long_1d,SIDRE_ADDRESS_ALLOCATABLE_LONG_1D)
void ADDRESS_ALLOCATABLE_LONG_1D(void * array, void * * addr);

#define ADDRESS_ALLOCATABLE_FLOAT_SCALAR FC_GLOBAL(sidre_address_allocatable_float_scalar,SIDRE_ADDRESS_ALLOCATABLE_FLOAT_SCALAR)
void ADDRESS_ALLOCATABLE_FLOAT_SCALAR(void * array, void * * addr);

#define ADDRESS_ALLOCATABLE_FLOAT_1D FC_GLOBAL(sidre_address_allocatable_float_1d,SIDRE_ADDRESS_ALLOCATABLE_FLOAT_1D)
void ADDRESS_ALLOCATABLE_FLOAT_1D(void * array, void * * addr);

#define ADDRESS_ALLOCATABLE_DOUBLE_SCALAR FC_GLOBAL(sidre_address_allocatable_double_scalar,SIDRE_ADDRESS_ALLOCATABLE_DOUBLE_SCALAR)
void ADDRESS_ALLOCATABLE_DOUBLE_SCALAR(void * array, void * * addr);

#define ADDRESS_ALLOCATABLE_DOUBLE_1D FC_GLOBAL(sidre_address_allocatable_double_1d,SIDRE_ADDRESS_ALLOCATABLE_DOUBLE_1D)
void ADDRESS_ALLOCATABLE_DOUBLE_1D(void * array, void * * addr);

//[[[end]]]

//[[[cog
//gen.print_lines(cog.outl, gen.print_sidre_allocate_allocatable_header)
//]]]
#define ALLOCATE_ALLOCATABLE_INT_SCALAR FC_GLOBAL(sidre_allocate_allocatable_int_scalar,SIDRE_ALLOCATE_ALLOCATABLE_INT_SCALAR)
void ALLOCATE_ALLOCATABLE_INT_SCALAR(void * array, long * nitems);

#define ALLOCATE_ALLOCATABLE_INT_1D FC_GLOBAL(sidre_allocate_allocatable_int_1d,SIDRE_ALLOCATE_ALLOCATABLE_INT_1D)
void ALLOCATE_ALLOCATABLE_INT_1D(void * array, long * nitems);

#define ALLOCATE_ALLOCATABLE_LONG_SCALAR FC_GLOBAL(sidre_allocate_allocatable_long_scalar,SIDRE_ALLOCATE_ALLOCATABLE_LONG_SCALAR)
void ALLOCATE_ALLOCATABLE_LONG_SCALAR(void * array, long * nitems);

#define ALLOCATE_ALLOCATABLE_LONG_1D FC_GLOBAL(sidre_allocate_allocatable_long_1d,SIDRE_ALLOCATE_ALLOCATABLE_LONG_1D)
void ALLOCATE_ALLOCATABLE_LONG_1D(void * array, long * nitems);

#define ALLOCATE_ALLOCATABLE_FLOAT_SCALAR FC_GLOBAL(sidre_allocate_allocatable_float_scalar,SIDRE_ALLOCATE_ALLOCATABLE_FLOAT_SCALAR)
void ALLOCATE_ALLOCATABLE_FLOAT_SCALAR(void * array, long * nitems);

#define ALLOCATE_ALLOCATABLE_FLOAT_1D FC_GLOBAL(sidre_allocate_allocatable_float_1d,SIDRE_ALLOCATE_ALLOCATABLE_FLOAT_1D)
void ALLOCATE_ALLOCATABLE_FLOAT_1D(void * array, long * nitems);

#define ALLOCATE_ALLOCATABLE_DOUBLE_SCALAR FC_GLOBAL(sidre_allocate_allocatable_double_scalar,SIDRE_ALLOCATE_ALLOCATABLE_DOUBLE_SCALAR)
void ALLOCATE_ALLOCATABLE_DOUBLE_SCALAR(void * array, long * nitems);

#define ALLOCATE_ALLOCATABLE_DOUBLE_1D FC_GLOBAL(sidre_allocate_allocatable_double_1d,SIDRE_ALLOCATE_ALLOCATABLE_DOUBLE_1D)
void ALLOCATE_ALLOCATABLE_DOUBLE_1D(void * array, long * nitems);

//[[[end]]]

//[[[cog
//gen.print_lines(cog.outl, gen.print_sidre_deallocate_allocatable_header)
//]]]
#define DEALLOCATE_ALLOCATABLE_INT_SCALAR FC_GLOBAL(sidre_deallocate_allocatable_int_scalar,SIDRE_DEALLOCATE_ALLOCATABLE_INT_SCALAR)
void DEALLOCATE_ALLOCATABLE_INT_SCALAR(void * array);

#define DEALLOCATE_ALLOCATABLE_INT_1D FC_GLOBAL(sidre_deallocate_allocatable_int_1d,SIDRE_DEALLOCATE_ALLOCATABLE_INT_1D)
void DEALLOCATE_ALLOCATABLE_INT_1D(void * array);

#define DEALLOCATE_ALLOCATABLE_LONG_SCALAR FC_GLOBAL(sidre_deallocate_allocatable_long_scalar,SIDRE_DEALLOCATE_ALLOCATABLE_LONG_SCALAR)
void DEALLOCATE_ALLOCATABLE_LONG_SCALAR(void * array);

#define DEALLOCATE_ALLOCATABLE_LONG_1D FC_GLOBAL(sidre_deallocate_allocatable_long_1d,SIDRE_DEALLOCATE_ALLOCATABLE_LONG_1D)
void DEALLOCATE_ALLOCATABLE_LONG_1D(void * array);

#define DEALLOCATE_ALLOCATABLE_FLOAT_SCALAR FC_GLOBAL(sidre_deallocate_allocatable_float_scalar,SIDRE_DEALLOCATE_ALLOCATABLE_FLOAT_SCALAR)
void DEALLOCATE_ALLOCATABLE_FLOAT_SCALAR(void * array);

#define DEALLOCATE_ALLOCATABLE_FLOAT_1D FC_GLOBAL(sidre_deallocate_allocatable_float_1d,SIDRE_DEALLOCATE_ALLOCATABLE_FLOAT_1D)
void DEALLOCATE_ALLOCATABLE_FLOAT_1D(void * array);

#define DEALLOCATE_ALLOCATABLE_DOUBLE_SCALAR FC_GLOBAL(sidre_deallocate_allocatable_double_scalar,SIDRE_DEALLOCATE_ALLOCATABLE_DOUBLE_SCALAR)
void DEALLOCATE_ALLOCATABLE_DOUBLE_SCALAR(void * array);

#define DEALLOCATE_ALLOCATABLE_DOUBLE_1D FC_GLOBAL(sidre_deallocate_allocatable_double_1d,SIDRE_DEALLOCATE_ALLOCATABLE_DOUBLE_1D)
void DEALLOCATE_ALLOCATABLE_DOUBLE_1D(void * array);

//[[[end]]]

//[[[cog
//gen.print_lines(cog.outl, gen.print_sidre_reallocate_allocatable_header)
//]]]
#define REALLOCATE_ALLOCATABLE_INT_SCALAR FC_GLOBAL(sidre_reallocate_allocatable_int_scalar,SIDRE_REALLOCATE_ALLOCATABLE_INT_SCALAR)
void REALLOCATE_ALLOCATABLE_INT_SCALAR(void * array, long nitems);

#define REALLOCATE_ALLOCATABLE_INT_1D FC_GLOBAL(sidre_reallocate_allocatable_int_1d,SIDRE_REALLOCATE_ALLOCATABLE_INT_1D)
void REALLOCATE_ALLOCATABLE_INT_1D(void * array, long nitems);

#define REALLOCATE_ALLOCATABLE_LONG_SCALAR FC_GLOBAL(sidre_reallocate_allocatable_long_scalar,SIDRE_REALLOCATE_ALLOCATABLE_LONG_SCALAR)
void REALLOCATE_ALLOCATABLE_LONG_SCALAR(void * array, long nitems);

#define REALLOCATE_ALLOCATABLE_LONG_1D FC_GLOBAL(sidre_reallocate_allocatable_long_1d,SIDRE_REALLOCATE_ALLOCATABLE_LONG_1D)
void REALLOCATE_ALLOCATABLE_LONG_1D(void * array, long nitems);

#define REALLOCATE_ALLOCATABLE_FLOAT_SCALAR FC_GLOBAL(sidre_reallocate_allocatable_float_scalar,SIDRE_REALLOCATE_ALLOCATABLE_FLOAT_SCALAR)
void REALLOCATE_ALLOCATABLE_FLOAT_SCALAR(void * array, long nitems);

#define REALLOCATE_ALLOCATABLE_FLOAT_1D FC_GLOBAL(sidre_reallocate_allocatable_float_1d,SIDRE_REALLOCATE_ALLOCATABLE_FLOAT_1D)
void REALLOCATE_ALLOCATABLE_FLOAT_1D(void * array, long nitems);

#define REALLOCATE_ALLOCATABLE_DOUBLE_SCALAR FC_GLOBAL(sidre_reallocate_allocatable_double_scalar,SIDRE_REALLOCATE_ALLOCATABLE_DOUBLE_SCALAR)
void REALLOCATE_ALLOCATABLE_DOUBLE_SCALAR(void * array, long nitems);

#define REALLOCATE_ALLOCATABLE_DOUBLE_1D FC_GLOBAL(sidre_reallocate_allocatable_double_1d,SIDRE_REALLOCATE_ALLOCATABLE_DOUBLE_1D)
 ...
 */
//[[[cog
//gen.print_lines(cog.outl, gen.print_sidre_c_loc_allocatable)
//]]]

void FC_GLOBAL(sidre_c_loc_allocatable_int_scalar,SIDRE_C_LOC_ALLOCATABLE_INT_SCALAR)
  (void * allocatable, void * * addr)
{
  *addr = allocatable;
}

void FC_GLOBAL(sidre_c_loc_allocatable_int_1d,SIDRE_C_LOC_ALLOCATABLE_INT_1D)
  (void * allocatable, void * * addr)
{
  *addr = allocatable;
}

void FC_GLOBAL(sidre_c_loc_allocatable_long_scalar,SIDRE_C_LOC_ALLOCATABLE_LONG_SCALAR)
  (void * allocatable, void * * addr)
{
  *addr = allocatable;
}

void FC_GLOBAL(sidre_c_loc_allocatable_long_1d,SIDRE_C_LOC_ALLOCATABLE_LONG_1D)
  (void * allocatable, void * * addr)
{
  *addr = allocatable;
}

void FC_GLOBAL(sidre_c_loc_allocatable_float_scalar,SIDRE_C_LOC_ALLOCATABLE_FLOAT_SCALAR)
  (void * allocatable, void * * addr)
{
  *addr = allocatable;
}

void FC_GLOBAL(sidre_c_loc_allocatable_float_1d,SIDRE_C_LOC_ALLOCATABLE_FLOAT_1D)
  (void * allocatable, void * * addr)
{
  *addr = allocatable;
}

void FC_GLOBAL(sidre_c_loc_allocatable_double_scalar,SIDRE_C_LOC_ALLOCATABLE_DOUBLE_SCALAR)
  (void * allocatable, void * * addr)
{
  *addr = allocatable;
}

void FC_GLOBAL(sidre_c_loc_allocatable_double_1d,SIDRE_C_LOC_ALLOCATABLE_DOUBLE_1D)
  (void * allocatable, void * * addr)
{
  *addr = allocatable;
}
