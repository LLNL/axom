...
module sidre_mod
    ...
    interface
        ...
        subroutine atk_databuffer_declare_external(self, type, len) &
...
contains
    ...
    subroutine databuffer_declare_external(obj, type, len)
        use iso_c_binding
        implicit none
        class(databuffer) :: obj
        integer(C_INT) :: type
        ...
        call atk_databuffer_declare_external(obj%voidptr, type, len)
