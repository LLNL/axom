...
contains
    ...
    function datagroup_register_allocatable_int_scalar_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_allocatable_int_scalar_ptr(group, name, lname, array, atk_type, rank) result(rv)
           use iso_c_binding
        ...
        lname = len_trim(name)
        rv%voidptr = ATK_register_allocatable_int_scalar_ptr(group%voidptr, name, lname, value, atk_type, ndim)
    ...
    function datagroup_register_allocatable_int_1d_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_allocatable_int_1d_ptr(group, name, lname, array, atk_type, rank) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
        ...
        lname = len_trim(name)
        rv%voidptr = ATK_register_allocatable_int_1d_ptr(group%voidptr, name, lname, value, atk_type, ndim)
    ...
    function datagroup_register_allocatable_long_scalar_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_allocatable_long_scalar_ptr(group, name, lname, array, atk_type, rank) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
        ...
        lname = len_trim(name)
        rv%voidptr = ATK_register_allocatable_long_scalar_ptr(group%voidptr, name, lname, value, atk_type, ndim)
    ...
    function datagroup_register_allocatable_long_1d_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_allocatable_long_1d_ptr(group, name, lname, array, atk_type, rank) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
        ...
        lname = len_trim(name)
        rv%voidptr = ATK_register_allocatable_long_1d_ptr(group%voidptr, name, lname, value, atk_type, ndim)
    ...
    function datagroup_register_allocatable_float_scalar_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_allocatable_float_scalar_ptr(group, name, lname, array, atk_type, rank) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
        ...
        lname = len_trim(name)
        rv%voidptr = ATK_register_allocatable_float_scalar_ptr(group%voidptr, name, lname, value, atk_type, ndim)
    ...
    function datagroup_register_allocatable_float_1d_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_allocatable_float_1d_ptr(group, name, lname, array, atk_type, rank) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
        ...
        lname = len_trim(name)
        rv%voidptr = ATK_register_allocatable_float_1d_ptr(group%voidptr, name, lname, value, atk_type, ndim)
    ...
    function datagroup_register_allocatable_double_scalar_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_allocatable_double_scalar_ptr(group, name, lname, array, atk_type, rank) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
        ...
        lname = len_trim(name)
        rv%voidptr = ATK_register_allocatable_double_scalar_ptr(group%voidptr, name, lname, value, atk_type, ndim)
    ...
    function datagroup_register_allocatable_double_1d_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_allocatable_double_1d_ptr(group, name, lname, array, atk_type, rank) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
        ...
        lname = len_trim(name)
        rv%voidptr = ATK_register_allocatable_double_1d_ptr(group%voidptr, name, lname, value, atk_type, ndim)
