...
contains
    ...
    function datagroup_register_static_int_scalar_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_static_int_scalar_ptr(group, name, lname, array, indx) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
           ...
           integer(C_INT), value, intent(IN) :: indx
           type(C_PTR) rv
           end function ATK_register_static_int_scalar_ptr
        end interface
        ...
        lname = len_trim(name)
    !    rv%voidptr = ATK_register_static_int_scalar_ptr(group%voidptr, name, lname, value, indx)
    ...
    function datagroup_register_static_int_1d_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_static_int_1d_ptr(group, name, lname, array, indx) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
           ...
           integer(C_INT), value, intent(IN) :: indx
           type(C_PTR) rv
           end function ATK_register_static_int_1d_ptr
        end interface
        ...
        lname = len_trim(name)
    !    rv%voidptr = ATK_register_static_int_1d_ptr(group%voidptr, name, lname, value, indx)
    ...
    function datagroup_register_static_long_scalar_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_static_long_scalar_ptr(group, name, lname, array, indx) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
           integer(C_LONG),              intent(IN) :: array
           integer(C_INT), value, intent(IN) :: indx
           type(C_PTR) rv
           end function ATK_register_static_long_scalar_ptr
        end interface
        ...
        lname = len_trim(name)
    !    rv%voidptr = ATK_register_static_long_scalar_ptr(group%voidptr, name, lname, value, indx)
    ...
    function datagroup_register_static_long_1d_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_static_long_1d_ptr(group, name, lname, array, indx) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
           ...
           integer(C_INT), value, intent(IN) :: indx
           type(C_PTR) rv
           end function ATK_register_static_long_1d_ptr
        end interface
        ...
        lname = len_trim(name)
    !    rv%voidptr = ATK_register_static_long_1d_ptr(group%voidptr, name, lname, value, indx)
    ...
    function datagroup_register_static_float_scalar_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_static_float_scalar_ptr(group, name, lname, array, indx) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
           ...
           integer(C_INT), value, intent(IN) :: indx
           type(C_PTR) rv
           end function ATK_register_static_float_scalar_ptr
        end interface
        ...
        lname = len_trim(name)
    !    rv%voidptr = ATK_register_static_float_scalar_ptr(group%voidptr, name, lname, value, indx)
    ...
    function datagroup_register_static_float_1d_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_static_float_1d_ptr(group, name, lname, array, indx) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
           ...
           integer(C_INT), value, intent(IN) :: indx
           type(C_PTR) rv
           end function ATK_register_static_float_1d_ptr
        end interface
        ...
        lname = len_trim(name)
    !    rv%voidptr = ATK_register_static_float_1d_ptr(group%voidptr, name, lname, value, indx)
    ...
    function datagroup_register_static_double_scalar_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_static_double_scalar_ptr(group, name, lname, array, indx) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
           ...
           integer(C_INT), value, intent(IN) :: indx
           type(C_PTR) rv
           end function ATK_register_static_double_scalar_ptr
        end interface
        ...
        lname = len_trim(name)
    !    rv%voidptr = ATK_register_static_double_scalar_ptr(group%voidptr, name, lname, value, indx)
    ...
    function datagroup_register_static_double_1d_ptr(group, name, value) result(rv)
        ...
        interface
           function ATK_register_static_double_1d_ptr(group, name, lname, array, indx) result(rv)
           use iso_c_binding
           type(C_PTR), value, intent(IN)    :: group
           character(*), intent(IN)          :: name
           integer(C_INT), value, intent(IN) :: lname
           ...
           integer(C_INT), value, intent(IN) :: indx
           type(C_PTR) rv
           end function ATK_register_static_double_1d_ptr
        end interface
        ...
        lname = len_trim(name)
    !    rv%voidptr = ATK_register_static_double_1d_ptr(group%voidptr, name, lname, value, indx)
