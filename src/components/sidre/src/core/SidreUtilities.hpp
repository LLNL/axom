...
namespace detail
{
  ...
  /** \brief Splits a string given the provided delimiter into a vector of strings.
   *  \param s The string to split
   *  \param c Delimiter character
   *  \param pos Starting position (pass in std::string::npos to start from the beginning)
  ...
  /** \brief Report the first position of a character in a string, with first or last being an error.
