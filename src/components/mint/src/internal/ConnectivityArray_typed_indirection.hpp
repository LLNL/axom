...
#ifndef MINT_ConnectivityArray_indirection_and_types_HXX_
#define MINT_ConnectivityArray_indirection_and_types_HXX_
...
#endif /* MINT_ConnectivityArray_indirection_and_types_HXX_ */