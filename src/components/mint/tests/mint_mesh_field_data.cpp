...
TEST( mint_mesh_field_data, sidre_constructor )
{
  ...
  add_field_to_group< double >( gp, "n1", NUM_TUPLES, NUM_COMPONENTS,
                                mint::NODE_CENTERED,
                                DOUBLE_MAGIC_NUM );
  add_field_to_group< double >( gp, "n2", NUM_TUPLES, NUM_COMPONENTS,
                                mint::NODE_CENTERED,
                                DOUBLE_MAGIC_NUM );
  add_field_to_group< int >( gp, "n3", NUM_TUPLES, NUM_COMPONENTS,
                             mint::NODE_CENTERED,
                             INT_MAGIC_NUM );

  // add cell-centered fields
  add_field_to_group< double >( gp, "c1", NUM_TUPLES, NUM_COMPONENTS,
                                mint::CELL_CENTERED,
                                DOUBLE_MAGIC_NUM );
