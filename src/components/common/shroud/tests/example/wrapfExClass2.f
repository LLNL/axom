...
contains
    ...
    subroutine exclass2_ex_class1(obj)
        ...
        implicit none
        type(exclass2) :: obj
        ! splicer begin ex_class1
        call aa_exclass2_ex_class1(obj%obj)
        obj%obj = C_NULL_PTR
        ! splicer end ex_class1
    ...
    function exclass2_get_class1(obj, in) result(rv)
        ...
        type(exclass1) :: in
        type(exclass1) :: rv
        ! splicer begin get_class1
        rv%obj = aa_exclass2_get_class1(obj%obj, in%obj)
        ! splicer end get_class1
    ...
    subroutine exclass2_destroyall(obj)
        ...
        implicit none
        class(exclass2) :: obj
        ! splicer begin destroyall
        call aa_exclass2_destroyall(obj%obj)
        ! splicer end destroyall
