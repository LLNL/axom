...
6.1 Documentation **should** only include what is essential for users and 
...
6.2 To make comment text clear and reduce confusion, code comments 
...
6.3 New source code **must** be documented following the guidelines in this 
section. Documentation of existing code **should** be modified to conform to 
these guidelines when appropriate. 

6.4 Existing code documentation **should** be improved when its inadequate,
incorrect, or unclear.

.. note:: When code is modified, documentation should be changed to reflect the
          changes.
...
6.5 End-of-line comments **should not** be used to document code logic, 
...
6.6 All comments, except end-of-line comments, **should** be indented to 
...
6.7 Comments **should** be clearly delimited from executable code with blank 
lines and "blocking characters" (see examples below) to make them stand out 
and, thus, improve the chances they will be read.

6.8 White space, such as blank lines, indentation, and vertical alignment 
...
6.9 Doxygen comment blocks **may** use either JavaDoc, Qt style, or one 
...
.. note:: Whichever Doxygen comment block style is used, it **must** be the 
          same within a file.
