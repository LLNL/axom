...
namespace detail {
template <typename Period> AXOM_FMT_CONSTEXPR const char* get_units() {
  return nullptr;
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::atto>() {
  return "as";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::femto>() {
  return "fs";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::pico>() {
  return "ps";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::nano>() {
  return "ns";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::micro>() {
  return "µs";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::milli>() {
  return "ms";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::centi>() {
  return "cs";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::deci>() {
  return "ds";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::ratio<1>>() {
  return "s";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::deca>() {
  return "das";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::hecto>() {
  return "hs";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::kilo>() {
  return "ks";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::mega>() {
  return "Ms";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::giga>() {
  return "Gs";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::tera>() {
  return "Ts";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::peta>() {
  return "Ps";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::exa>() {
  return "Es";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::ratio<60>>() {
  return "m";
}
template <> AXOM_FMT_CONSTEXPR inline const char* get_units<std::ratio<3600>>() {
  return "h";
}
...
struct chrono_format_checker {
  AXOM_FMT_NORETURN void report_no_date() { AXOM_FMT_THROW(format_error("no date")); }

  template <typename Char>
  AXOM_FMT_CONSTEXPR void on_text(const Char*, const Char*) {}
  AXOM_FMT_NORETURN void on_abbr_weekday() { report_no_date(); }
  AXOM_FMT_NORETURN void on_full_weekday() { report_no_date(); }
  AXOM_FMT_NORETURN void on_dec0_weekday(numeric_system) { report_no_date(); }
  AXOM_FMT_NORETURN void on_dec1_weekday(numeric_system) { report_no_date(); }
  AXOM_FMT_NORETURN void on_abbr_month() { report_no_date(); }
  AXOM_FMT_NORETURN void on_full_month() { report_no_date(); }
  ...
  AXOM_FMT_NORETURN void on_datetime(numeric_system) { report_no_date(); }
  AXOM_FMT_NORETURN void on_loc_date(numeric_system) { report_no_date(); }
  AXOM_FMT_NORETURN void on_loc_time(numeric_system) { report_no_date(); }
  AXOM_FMT_NORETURN void on_us_date() { report_no_date(); }
  AXOM_FMT_NORETURN void on_iso_date() { report_no_date(); }
  ...
  AXOM_FMT_NORETURN void on_utc_offset() { report_no_date(); }
  AXOM_FMT_NORETURN void on_tz_name() { report_no_date(); }
};
...
inline int to_nonnegative_int(T value, int upper) {
  AXOM_FMT_ASSERT(value >= 0 && to_unsigned(value) <= to_unsigned(upper),
             "invalid value");
  (void)upper;
