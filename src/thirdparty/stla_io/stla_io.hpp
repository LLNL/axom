 ...
 * \file
 *
 * \brief A subset of the STLA_IO library used for reading ASCII STL files.
 *
 * \note Code: http://people.sc.fsu.edu/~jburkardt/cpp_src/stla_io/stla_io.html
 * \note License: http://people.sc.fsu.edu/~jburkardt/txt/gnu_lgpl.txt
 ******************************************************************************
 */
#ifndef STL_IO_HPP_
#define STL_IO_HPP_
