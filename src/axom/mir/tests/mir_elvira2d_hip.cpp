...
TEST(mir_elvira2d_hip, elvira_uniform_unibuffer_hip)
{
...
TEST(mir_elvira2d_hip, elvira_uniform_unibuffer_sel_hip)
{
...
TEST(mir_elvira2d_hip, elvira_uniform_unibuffer_pm_hip)
{
...
TEST(mir_elvira2d_hip, elvira_uniform_unibuffer_sel_pm_hip)
{
