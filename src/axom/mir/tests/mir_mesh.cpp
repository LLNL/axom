...
protected:
  void SetUp() override
  {
    ...
    m_mesh.initializeMesh(this->m_verts,
                          this->m_elems,
                          this->m_nMats,
                          this->m_topoData,
                          this->m_mapData,
  ...
  void setupTopoData()
  {
    ...
    m_topoData.m_evBegins = {0, 4, 8, 12, 16, 20, 24, 28, 32, 36};
  ...
  void setupMapData()
  {
    m_mapData.m_vertexPositions = {mir::Point2(0.0, 3.0),
                                   mir::Point2(1.0, 3.0),
                                   mir::Point2(2.0, 3.0),
                                   mir::Point2(3.0, 3.0),
    ...
    m_mapData.m_elementDominantMaterials =
      Vec<int>(m_elems.size(), mir::NULL_MAT);
...
{
  mir::MIRMesh mesh;
  mesh.initializeMesh(this->m_verts,
                      this->m_elems,
                      this->m_nMats,
                      this->m_topoData,
                      this->m_mapData,
