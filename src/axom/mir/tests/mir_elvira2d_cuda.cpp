...
TEST(mir_elvira2d_cuda, elvira_uniform_unibuffer_cuda)
{
...
TEST(mir_elvira2d_cuda, elvira_uniform_unibuffer_sel_cuda)
{
...
TEST(mir_elvira2d_cuda, elvira_uniform_unibuffer_pm_cuda)
{
...
TEST(mir_elvira2d_cuda, elvira_uniform_unibuffer_sel_pm_cuda)
{
