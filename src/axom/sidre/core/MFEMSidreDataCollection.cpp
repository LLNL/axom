                     ...
                     axom::sidre::IndexType offset)
{
   ...
   SLIC_ASSERT_MSG(grp != NULL, "qfield " << field_name << " does not exist");
                                        ...
                                        axom::sidre::IndexType offset)
{
   ...
   {
#ifdef AXOM_DEBUG
      SLIC_WARNING("QField with the name '" << field_name << "' was provided a null"
   ...
   if (f->hasGroup( field_name ))
   {
      ...
      if (HasQField(field_name))
      {
         ...
         if (field_name != m_meshNodesGFName)
         {
            SLIC_WARNING("QField with the name '" << field_name<< "' is already "
