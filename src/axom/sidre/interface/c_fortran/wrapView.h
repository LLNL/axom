...
void SIDRE_view_get_path_name_bufferify(const SIDRE_view * self, char * SHF_rv, int NSHF_rv);
...
void SIDRE_view_allocate_from_type(SIDRE_view * self, int type, SIDRE_IndexType num_elems);
...
void SIDRE_view_attach_buffer_type(SIDRE_view * self, int type, SIDRE_IndexType num_elems, SIDRE_buffer * buff);

void SIDRE_view_attach_buffer_shape(SIDRE_view * self, int type, int ndims, SIDRE_IndexType * shape, SIDRE_buffer * buff);
...
void SIDRE_view_apply_nelems_offset_stride(SIDRE_view * self, SIDRE_IndexType num_elems, SIDRE_IndexType offset, SIDRE_IndexType stride);

void SIDRE_view_apply_type_nelems(SIDRE_view * self, int type, SIDRE_IndexType num_elems);

void SIDRE_view_apply_type_nelems_offset(SIDRE_view * self, int type, SIDRE_IndexType num_elems, SIDRE_IndexType offset);

void SIDRE_view_apply_type_nelems_offset_stride(SIDRE_view * self, int type, SIDRE_IndexType num_elems, SIDRE_IndexType offset, SIDRE_IndexType stride);

void SIDRE_view_apply_type_shape(SIDRE_view * self, int type, int ndims, SIDRE_IndexType * shape);
...
void SIDRE_view_set_external_data_ptr_type(SIDRE_view * self, int type, SIDRE_IndexType num_elems, void * external_ptr);

void SIDRE_view_set_external_data_ptr_shape(SIDRE_view * self, int type, int ndims, SIDRE_IndexType * shape, void * external_ptr);
