...
// splicer begin class.Group.method.get_data_store
    ...
    SHC_rv->addr = static_cast<void *>(const_cast<axom::sidre::DataStore *>(SHCXX_rv));
    SHC_rv->idtor = 0;
    return SHC_rv;
...
// splicer begin class.Group.method.create_view_from_type
    ...
    axom::sidre::View * SHCXX_rv = SH_this->createView(SH_path, SHCXX_type, num_elems);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
...
// splicer begin class.Group.method.create_view_from_shape
    ...
    const std::string SH_path(path);
    axom::sidre::TypeID SHCXX_type = axom::sidre::getTypeID(type);
    axom::sidre::View * SHCXX_rv = SH_this->createView(SH_path, SHCXX_type, ndims, shape);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
...
// splicer begin class.Group.method.create_view_from_type_and_buffer
    ...
    axom::sidre::TypeID SHCXX_type = axom::sidre::getTypeID(type);
    axom::sidre::Buffer * SHCXX_buff = static_cast<axom::sidre::Buffer *>(buff->addr);
    axom::sidre::View * SHCXX_rv = SH_this->createView(SH_path, SHCXX_type, num_elems, SHCXX_buff);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
...
// splicer begin class.Group.method.create_view_from_shape_and_buffer
    ...
    axom::sidre::TypeID SHCXX_type = axom::sidre::getTypeID(type);
    axom::sidre::Buffer * SHCXX_buff = static_cast<axom::sidre::Buffer *>(buff->addr);
    axom::sidre::View * SHCXX_rv = SH_this->createView(SH_path, SHCXX_type, ndims, shape, SHCXX_buff);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
...
// splicer begin class.Group.method.create_view_from_type_external
    ...
    const std::string SH_path(path);
    axom::sidre::TypeID SHCXX_type = axom::sidre::getTypeID(type);
    axom::sidre::View * SHCXX_rv = SH_this->createView(SH_path, SHCXX_type, num_elems, external_ptr);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
...
// splicer begin class.Group.method.create_view_from_shape_external
    ...
    const std::string SH_path(path);
    axom::sidre::TypeID SHCXX_type = axom::sidre::getTypeID(type);
    axom::sidre::View * SHCXX_rv = SH_this->createView(SH_path, SHCXX_type, ndims, shape, external_ptr);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
...
// splicer begin class.Group.method.create_view_and_allocate_nelems
    ...
    const std::string SH_path(path);
    axom::sidre::TypeID SHCXX_type = axom::sidre::getTypeID(type);
    axom::sidre::View * SHCXX_rv = SH_this->createViewAndAllocate(SH_path, SHCXX_type, num_elems);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
...
// splicer begin class.Group.method.create_view_and_allocate_shape
    ...
    const std::string SH_path(path);
    axom::sidre::TypeID SHCXX_type = axom::sidre::getTypeID(type);
    axom::sidre::View * SHCXX_rv = SH_this->createViewAndAllocate(SH_path, SHCXX_type, ndims, shape);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
...
// splicer begin class.Group.method.create_view_scalar_float
    axom::sidre::Group *SH_this = static_cast<axom::sidre::Group *>(self->addr);
    const std::string SH_path(path);
    axom::sidre::View * SHCXX_rv = SH_this->createViewScalar<float>(SH_path, value);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
...
// splicer begin class.Group.method.create_view_scalar_double
    axom::sidre::Group *SH_this = static_cast<axom::sidre::Group *>(self->addr);
    const std::string SH_path(path);
    axom::sidre::View * SHCXX_rv = SH_this->createViewScalar<double>(SH_path, value);
    // C_error_pattern
    if (SHCXX_rv == nullptr) {
        SHC_rv->addr = NULL;
        SHC_rv->idtor = 0; 
