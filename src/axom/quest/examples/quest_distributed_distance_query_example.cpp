...
public:
  ...
  std::string getMdMeshName() const
  {
    ...
    // Remove the parent directories and file suffix
    std::string name = axom::Path(mdMeshFile).baseName();
    name = removeSuffix(name, ".root");
  ...
  void parse(int argc, char** argv, axom::CLI::App& app)
  {
    ...
    app.add_option("-M,--mdmesh-file", mdMeshFile)
      ->description(
...
public:
  ...
  */
  void read_blueprint_mesh(const std::string& meshFilename)
  {
    ...
    std::cout << "Multidomain mesh from " << mdMeshFilename << std::endl;
    mdMesh.print();
#endif
#endif
