 ...
 */
PointType project_to_shape(const PointType & p, SphereType &sphere)
{
 ...
 */
OctType from_sphere(SphereType & sphere)
{
 ...
 */ 
OctType new_inscribed_oct(SphereType & sphere,
                          OctType & o,
                          int s,
                          int t,
                          int u)
 ...
 */
void discretize(SphereType & sphere,
                int levels,
