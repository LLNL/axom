...
TEST(primal_nurbscurve, evaluate)
{
  ...
  PointType exp_mid_vals[4][4] =   // degree 0                    degree 1                    degree 2                         degree 3
          /* 1 pt */ {{PointType {0.6, 1.2, 1.0}, PointType {-999,-999, -999}, PointType { -999,-999,  -999}, PointType {-999,   -999,   -999}},
          /* 2 pt */  {PointType {1.3, 1.6, 1.8}, PointType {0.95, 1.4,  1.4}, PointType { -999,-999,  -999}, PointType {-999,   -999,   -999}},
          /* 3 pt */  {PointType {1.3, 1.6, 1.8}, PointType { 1.3, 1.6,  1.8}, PointType {1.525, 1.7, 1.725}, PointType {-999,   -999,   -999}},
          /* 4 pt */  {PointType {2.9, 2.4, 2.3}, PointType { 2.1, 2.0, 2.05}, PointType {  2.1, 2.0,  2.05}, PointType {2.05, 2.0875, 2.0375}}};
...
TEST(primal_nurbscurve, first_derivatives)
{
  ...
  VectorType exp_start_vals[4][4] =  // degree 0                  degree 1                   degree 2                   degree 3
          ...
          /* 2 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.7, 0.4, 0.8}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}},
          /* 3 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 1.4, 0.8, 1.6}, VectorType { 1.4, 0.8, 1.6}, VectorType {-999,-999,-999}},
          /* 4 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 2.1, 1.2, 2.4}, VectorType { 2.8, 1.6, 3.2}, VectorType { 2.1, 1.2, 2.4}}};

  VectorType exp_mid_vals[4][4] =   // degree 0                    degree 1                    degree 2                         degree 3
          /* 1 pt */ {{VectorType {0.0, 0.0, 0.0}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}, VectorType {-999,  -999,  -999}},
          /* 2 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.7, 0.4, 0.8}, VectorType {-999,-999,-999}, VectorType {-999,  -999,  -999}},
          /* 3 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 3.2, 1.6, 1.0}, VectorType { 2.3, 1.2, 1.3}, VectorType {-999,  -999,  -999}},
          /* 4 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 4.8, 2.4, 1.5}, VectorType { 3.2, 1.6, 1.0}, VectorType {3.15, 2.325, 1.875}}};

  VectorType exp_end_vals[4][4] =  // degree 0                  degree 1                   degree 2                   degree 3
          /* 1 pt */ {{VectorType {0.0, 0.0, 0.0}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}},
          /* 2 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.7, 0.4, 0.8}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}},
          /* 3 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 3.2, 1.6, 1.0}, VectorType { 3.2, 1.6, 1.0}, VectorType {-999,-999,-999}},
          /* 4 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.9, 3.3, 2.1}, VectorType { 1.2, 4.4, 2.8}, VectorType { 0.9, 3.3, 2.1}}};
  // clang-format on
...
TEST(primal_nurbscurve, second_derivatives)
{
  ...
  VectorType exp_start_vals[4][4] =  // degree 0                  degree 1                   degree 2                   degree 3
          /* 1 pt */ {{VectorType {0.0, 0.0, 0.0}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}},
          /* 2 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0,0, 0.0, 0.0}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}},
          /* 3 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0,0, 0.0, 0.0}, VectorType { 1.8, 0.8,-0.6}, VectorType {-999,-999,-999}},
          /* 4 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0,0, 0.0, 0.0}, VectorType { 0.8, 0.0,-4.4}, VectorType { 5.4, 2.4,-1.8}}};

  VectorType exp_mid_vals[4][4] =   // degree 0                    degree 1                    degree 2                         degree 3
          /* 1 pt */ {{VectorType {0.0, 0.0, 0.0}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}},
          /* 2 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.0, 0.0, 0.0}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}},
          /* 3 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.0, 0.0, 0.0}, VectorType { 1.8, 0.8,-0.6}, VectorType {-999,-999,-999}},
          /* 4 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.0, 0.0, 0.0}, VectorType {-4.0, 5.6, 3.6}, VectorType {-1.2, 2.1,-0.3}}};

  VectorType exp_end_vals[4][4] =  // degree 0                  degree 1                   degree 2                   degree 3
          /* 1 pt */ {{VectorType {0.0, 0.0, 0.0}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}},
          /* 2 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.0, 0.0, 0.0}, VectorType {-999,-999,-999}, VectorType {-999,-999,-999}},
          /* 3 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.0, 0.0, 0.0}, VectorType { 1.8, 0.8,-0.6}, VectorType {-999,-999,-999}},
          /* 4 pt */  {VectorType {0.0, 0.0, 0.0}, VectorType { 0.0, 0.0, 0.0}, VectorType {-4.0, 5.6, 3.6}, VectorType {-7.8, 1.8, 1.2}}};
  // clang-format on
