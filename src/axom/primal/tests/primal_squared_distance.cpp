...
{
  primal::Point< double,
                 2 > A = primal::Point< double,2 >::make_point( 0.0, 0.0 );
  primal::Point< double,
                 2 > B = primal::Point< double,2 >::make_point( 1.5, 1.5 );
...
TEST( primal_squared_distance, point_to_triangle )
{
  ...
  primal::Point< double,
                 3 > mid_of_AB = primal::Point< double,3 >::midpoint(A,B);
  dist = primal::squared_distance( mid_of_AB, tri );
  EXPECT_DOUBLE_EQ( 0.0f, dist );

  primal::Point< double,
                 3 > mid_of_BC = primal::Point< double,3 >::midpoint(B,C);
  dist = primal::squared_distance( mid_of_BC, tri );
  EXPECT_DOUBLE_EQ( 0.0f, dist );

  primal::Point< double,
                 3 > mid_of_AC = primal::Point< double,3 >::midpoint(A,C);
  ...
  // projected along z+
  primal::Point< double,
                 3 > q=primal::Point< double,3 >::make_point(1.5,0.5,0.5);
...
TEST( primal_squared_distance, point_to_segment )
{
  ...
  primal::Point< double,
                 2 > q0 = primal::Point< double,2 >::make_point( 0.5,10 );
