...
inline AXOM_HOST_DEVICE axom::common::int32 expand_bits32(axom::common::int32 x32)
{
...
inline AXOM_HOST_DEVICE axom::common::int64 expand_bits64(axom::common::int32 x)
{
...
inline AXOM_HOST_DEVICE axom::common::int32 morton_3d(axom::common::float32 &x, axom::common::float32 &y, axom::common::float32 &z)
{
...
inline AXOM_HOST_DEVICE axom::common::int64 morton_3d_64(axom::common::float32& x, axom::common::float32& y, axom::common::float32& z)
{
