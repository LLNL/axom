...
inline AXOM_HOST_DEVICE Vec<FloatType, 2> make_vec(const FloatType &a,
                                                   const FloatType &b)
{
...
template <typename FloatType>
inline AXOM_HOST_DEVICE Vec<FloatType, 3> make_vec(const FloatType &a,
                                                   const FloatType &b,
                                                   const FloatType &c)
{
  AXOM_STATIC_ASSERT(std::is_floating_point<FloatType>::value);
...
inline AXOM_HOST_DEVICE Vec2i make_vec2i(const axom::int32 &a,
                                         const axom::int32 &b)
{
  Vec2i res;
  res[0] = a;
...
inline AXOM_HOST_DEVICE Vec2li make_vec2li(const axom::int64 &a,
                                           const axom::int64 &b)
{
  Vec2li res;
  res[0] = a;
...
inline AXOM_HOST_DEVICE Vec2f make_vec2f(const axom::float32 &a,
...
inline AXOM_HOST_DEVICE Vec2d make_vec2d(const axom::float64 &a,
...
inline AXOM_HOST_DEVICE Vec3i make_vec3i(const axom::int32 &a,
                                         const axom::int32 &b,
                                         const axom::int32 &c)
{
  Vec3i res;
...
inline AXOM_HOST_DEVICE Vec3li make_vec3li(const axom::int64 &a,
                                           const axom::int64 &b,
                                           const axom::int64 &c)
{
  Vec3li res;
...
inline AXOM_HOST_DEVICE Vec3f make_vec3f(const axom::float32 &a,
                                         const axom::float32 &b,
...
inline AXOM_HOST_DEVICE Vec3d make_vec3d(const axom::float64 &a,
                                         const axom::float64 &b,
...
inline AXOM_HOST_DEVICE Vec4i make_vec4i(const axom::int32 &a,
                                         const axom::int32 &b,
                                         const axom::int32 &c,
                                         const axom::int32 &d)
{
...
inline AXOM_HOST_DEVICE Vec4li make_vec4li(const axom::int64 &a,
                                           const axom::int64 &b,
                                           const axom::int64 &c,
                                           const axom::int64 &d)
{
...
inline AXOM_HOST_DEVICE Vec4f make_vec4f(const axom::float32 &a,
                                         const axom::float32 &b,
                                         const axom::float32 &c,
...
inline AXOM_HOST_DEVICE Vec4d make_vec4d(const axom::float64 &a,
                                         const axom::float64 &b,
                                         const axom::float64 &c,
