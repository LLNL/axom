...
###############################################################################
#
# Axom Spin documentation build configuration file, created by
...
latex_documents = [
  ('index', 'Spin.tex', u'Spin Documentation',
   u'LLNS', 'manual'),
]
...
man_pages = [
    ('index', 'spin', u'Spin Documentation',
     [u'LLNS'], 1)
]
...
texinfo_documents = [
  ('index', 'Spin', u'Spin Documentation',
   u'LLNS', 'Spin', 'Spatial Index Component',
   'Miscellaneous'),
]
...
breathe_projects = { "spin": "../doxygen/xml/" }

breathe_default_project = "spin"
