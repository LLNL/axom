...
TEST( numerics_polynomial_solve, solve_cubic )
{
  ...
  // coeff[3] = a, coeff[2] = b, coeff[1] = c, coeff[0] = d.
  {
    ...
    coeff[0] = -1.728; coeff[1] = 4.32; coeff[2] = -3.6; coeff[3] = 1;
    roots[0] = 0; roots[1] = 0; roots[2] = 0;
    expected[0] = 1.2; expected[1] = 1.2; expected[2] = 1.2;
...

  {
    ...
    coeff[0] = 10; coeff[1] = -1; coeff[2] = 0; coeff[3] = -1;
    roots[0] = 0; roots[1] = 0; roots[2] = 0;
    expected[0] = 2; expected[1] = 0; expected[2] = 0;
    rc = axom::numerics::solve_cubic(coeff, roots, n);
    EXPECT_EQ(rc, 0);
    EXPECT_EQ(n, 1);
...

  {
    ...
    coeff[0] = -12; coeff[1] = -8; coeff[2] = 1; coeff[3] = 1;
    roots[0] = 0; roots[1] = 0; roots[2] = 0;
    expected[0] = 3; expected[1] = -2; expected[2] = -2;
    rc = axom::numerics::solve_cubic(coeff, roots, n);
    EXPECT_EQ(rc, 0);
    EXPECT_EQ(n, 2);
    EXPECT_EQ(count_mismatches(expected, roots, 3), 0);
...

  {
    ...
    roots[0] = 0; roots[1] = 0; roots[2] = 0;
    expected[0] = 8; expected[1] = 1; expected[2] = -0.8;
    rc = axom::numerics::solve_cubic(coeff, roots, n);
    EXPECT_EQ(rc, 0);
    EXPECT_EQ(n, 3);
    EXPECT_EQ(count_mismatches(expected, roots, 3), 0);
