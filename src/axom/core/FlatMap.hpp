...
public:
   ...
   */
  explicit FlatMap(Allocator allocator = Allocator {})
    : FlatMap(MIN_NUM_BUCKETS, allocator)
  { }
  ...
  , m_loadCount(0)
{
  ...
  m_metadata =
    axom::Array<BucketType>(numGroupsRounded, numGroupsRounded, m_allocator.get());
