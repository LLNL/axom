 ...
 * \param FACE_NODES an array; the node offsets specifying each face (CCW).
 */
...
#define MAX_ONE_FACE_NODES 4
#define MAX_ALL_FACES_NODES 24
...
typedef struct
{
  ...
  int face_nodes[MAX_ALL_FACES_NODES]; /*!< nodes for each of cell's faces */
} CellInfo;
