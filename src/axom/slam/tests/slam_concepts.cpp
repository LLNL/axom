...
// UnivariateSetLike is what separates it from a one-dimensional set.
...
static_assert(!slam::UnivariateSetLike<Product>);
static_assert(slam::UnivariateSetLike<Range>);
static_assert(slam::UnivariateSetLike<ConcreteRange>);
static_assert(slam::BivariateSetLike<BivariateSetLikeIsASet>);
static_assert(slam::SetLike<BivariateSetLikeIsASet>);
static_assert(!slam::UnivariateSetLike<BivariateSetLikeIsASet>);
...
static_assert(slam::SetSizePolicyFor<RuntimeSize, int>);
static_assert(slam::SetSizePolicyFor<Size, int>);
static_assert(slam::SetSizePolicyFor<EmptySize, int>);
static_assert(slam::SizePolicy<WrongRuntimeSize>);
static_assert(!slam::SetSizePolicyFor<WrongRuntimeSize, int>);
static_assert(!slam::SetSizePolicyFor<WrongCompileTimeSize, int>);
static_assert(!slam::SetSizePolicyFor<WrongEmptySize, int>);
...
static_assert(slam::OrderedSetOffsetPolicyFor<EmptyOffset, int>);
static_assert(!slam::OrderedSetOffsetPolicyFor<WrongRuntimeOffset, int>);
static_assert(!slam::OrderedSetOffsetPolicyFor<WrongCompileTimeOffset, int>);
static_assert(!slam::OrderedSetOffsetPolicyFor<WrongEmptyOffset, int>);
