...
// //copied from Map test...
//
//TEST(slam_map,out_of_bounds)
//{
//  int defaultElt = 2;
//
//  RangeSetType s(MAX_SET_SIZE);
...
//    {
//      *iter = static_cast<DataType>(idx * multFac);
//      idx++;
//    }
//  }
//
...
//    for (int idx = 0; idx<m.size(); idx++)
//    {
//      EXPECT_EQ(beginIter[idx], static_cast<DataType>(idx * multFac));
//    }
//  }
//
//  EXPECT_TRUE(m.isValid(true));
