...
set(TPL_ROOT "/usr/WS1/axom/libs/blueos_3_ppc64le_ib_p9/2024_09_20_12_08_37/gcc-8.3.1.2" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.2-lpxucas2inowafnybsynioedgefp5hat" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-lzutypczagwoia6i3no5b7ultlwlfk2d" CACHE PATH "")

# MFEM not built

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-z4eikslhnkmfk5zgii42qdzge3kad2pf" CACHE PATH "")

set(LUA_DIR "${TPL_ROOT}/lua-5.4.6-p4jxnpewmedoswsbzkyoxkiqi6wfmw6c" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2024.07.0-xjr3v2x6vjtgpov7qv3kcewhhczxa476" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2024.07.0-gewshapnzceyrwrq47jrmq4whicbn7gd" CACHE PATH "")

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-libudcuo2476lopipmj6nbbo64hrrfrv" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-2.10.0-cpx3bnudfnfpzr4vpstkt4qbdxfokz4f" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2024.07.0-pgzto3ewwjaos2djedcrgis3odobq6ip" CACHE PATH "")
...
set(JSONSCHEMA_EXECUTABLE "${TPL_ROOT}/py-jsonschema-4.17.3-cxdbzzin4uuhuvgnj3wzkiko5jobwswb/bin/jsonschema" CACHE PATH "")
