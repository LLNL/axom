...
if(DEFINED ENV{SPACK_CC})
  ...
  set(CMAKE_C_COMPILER "/usr/WS1/axom/libs/blueos_3_ppc64le_ib_p9/2024_09_20_10_38_34/spack/lib/spack/env/gcc/gcc" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/usr/WS1/axom/libs/blueos_3_ppc64le_ib_p9/2024_09_20_10_38_34/spack/lib/spack/env/gcc/g++" CACHE PATH "")

  set(CMAKE_Fortran_COMPILER "/usr/WS1/axom/libs/blueos_3_ppc64le_ib_p9/2024_09_20_10_38_34/spack/lib/spack/env/gcc/gfortran" CACHE PATH "")
...
set(TPL_ROOT "/usr/WS1/axom/libs/blueos_3_ppc64le_ib_p9/2024_09_20_10_38_34/gcc-8.3.1.1" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.2-xko66o26xogtrkhx6fup7fxbran4cxsr" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-fhz7neofq7onv64sz5ng4jrjhexq737h" CACHE PATH "")

# MFEM not built

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-neg57xjlirvook5q6jfbfsdqlzgg22kt" CACHE PATH "")

set(LUA_DIR "${TPL_ROOT}/lua-5.4.6-jzxxu3fdouzimeobsoi4fxagniz2ifqm" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2024.07.0-tacuivcrlzzixfalvj6pxtczpknktvva" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2024.07.0-bb5l75qqckeltddcxw4ocscrisjikg4k" CACHE PATH "")

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-o226evmovhe324pehwnwirspkftw5ruw" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-2.10.0-igdj2aqvbvpw6lfmukkqy6rgyft63iys" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2024.07.0-tsuutmbufqwy7befezinmjkchmyhxixj" CACHE PATH "")
...
set(JSONSCHEMA_EXECUTABLE "${TPL_ROOT}/py-jsonschema-4.17.3-utexjihktg3mk6wkcid6ibkbazkp2uzj/bin/jsonschema" CACHE PATH "")
