...
set(TPL_ROOT "/usr/WS1/axom/libs/blueos_3_ppc64le_ib_p9/2023_05_19_09_25_23/xl-16.1.1.1" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.8.6-izqbwbdmexha2bh2vluzjt6duubcxzb6" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-3mxn4d3wgfiljubocb7sb4dswpimhobq" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.5.0-fk7der7nohymzlqzcetzq64onnojdbli" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.22-xod2eunritkk5od45uqebhmdwaas2tso" CACHE PATH "")

set(LUA_DIR "${TPL_ROOT}/lua-5.4.4-m2xojgjzvpc326wzg2iohzmcrmbfbc77" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2022.03.0-k3yzikciigtcwkmich4lxxezmrgwflyb" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2022.03.1-3lrbed7qan2ymcznuv5vmcrgi7j6kcwz" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2022.10.1-w2ekmi65ykhpizsujdkp3hxipkcuwq45" CACHE PATH "")
