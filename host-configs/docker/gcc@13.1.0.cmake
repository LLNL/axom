...
set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.2-lcdtevgkh5bbpklklnvsowc3vdditqpo" CACHE PATH "")

# C2C not built

set(MFEM_DIR "${TPL_ROOT}/mfem-4.6.0-5fjoim3uxggiliuc44wui67rbjmgh7hq" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-oi5ufdr27irz6rnjdj656eou2od3zfrc" CACHE PATH "")

set(LUA_DIR "/usr" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2024.07.0-rymjdaxurpykwax25lwylyiv772poffj" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2024.07.0-k3g2kkrgg3xm7gd4wk77muqugnot6fft" CACHE PATH "")

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-a5snac3dmnvrdevxvs6g3fgswpl6rwk3" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-2.10.0-tdr37n7gay6uoqmdw2oj4wwaxdghgtn5" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2024.07.0-wneowcxzurhqrmg42ogjv63gyfhr2lnd" CACHE PATH "")
