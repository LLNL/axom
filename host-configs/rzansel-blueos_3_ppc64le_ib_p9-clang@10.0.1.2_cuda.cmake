...
set(TPL_ROOT "/usr/WS1/axom/libs/blueos_3_ppc64le_ib_p9/2024_03_25_14_14_33/clang-10.0.1.2" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.1-mypcbb7eqvp4oqjftdvw53oql5f5wemd" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-ouuns7euqd3fbobccnfh2zcfgxo2nsss" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.6.0-63jbjowv2dojriwkpag6ws3tbm4erk7v" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-5n6b7og6vcevg2pkbjjrhf54ta4fhl2i" CACHE PATH "")

set(LUA_DIR "${TPL_ROOT}/lua-5.4.4-5okbr3yhq4vyonc2yt22lich6jkdgp3i" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2024.02.0-tmdjtmc2qovl2jaqnutbv45bmhc4zn4o" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2024.02.0-nbggyfwzpho4in5554uaantfkjy3ivvo" CACHE PATH "")

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-6l23za73d6c7kgr5wuwjliudtnnuvoch" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-2.10.0-avlzufmrw3vohgzahhqiso76txua2lte" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2024.02.0-akuafbdichhwo33l4xm7g4r73cixmokh" CACHE PATH "")
...
set(JSONSCHEMA_EXECUTABLE "${TPL_ROOT}/py-jsonschema-2.6.0-jzezi7fphud2hpmaepsb5s456tz2dqol/bin/jsonschema" CACHE PATH "")
