...
set(TPL_ROOT "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2023_06_21_15_15_50/clang-15.0.0" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.8.6-rfxxtopd2mfha66e2amph7xesjljl62r" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-w3miiiztg3zxr2z23dxpibcv3655lape" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.5.0-nym2vsyl2mxkvczbabfd4turwnvbjadl" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.22-adojxdc5htttyo4ifmvz2ykk2bnc2q3e" CACHE PATH "")

set(LUA_DIR "${TPL_ROOT}/lua-5.4.4-p6ucuzptyhvlaolwlxliaj4kwhihgwzh" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2022.03.0-bca5ndzdpx657uzu2m66ldlhiympirdy" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2022.03.1-wy3mjawp5zo3xoyhmpv6vfpps3ptwbqj" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2022.10.1-cfxcf5sr4nzeacjxf7hcsxfrljs4klyk" CACHE PATH "")
