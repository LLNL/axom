...
set(TPL_ROOT "/usr/WS1/axom/libs/blueos_3_ppc64le_ib_p9/2024_09_20_12_08_37/clang-10.0.1.1" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.2-ens4rgdgdajilvi3c55iytz23xn5glmj" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-rgjmyonou62nflsbgfdm3u4remw34r4n" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.6.0-jxhxmzp7gdcqhbobo45dxufmxcntnwr2" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-aczjq5qi2jukowvggky77o65uzpqekon" CACHE PATH "")

set(LUA_DIR "${TPL_ROOT}/lua-5.4.6-s6rq2f63siahgk3fdrqhj5znoryyvxof" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2024.07.0-t7ugyy6v73kxhyv3xdy5qc4arq4hxnpm" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2024.07.0-n6y27zlhzvoijl4xun6u6lbkfup5jusv" CACHE PATH "")

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-m7mafehgzcfksk2fzvkhx4snhutws5lz" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-2.10.0-6rqvljka5ovotmnhp66f2p3cjh5dbooe" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2024.07.0-3gaddmuz46hdqorhfpraut67lbds3riz" CACHE PATH "")
...
set(JSONSCHEMA_EXECUTABLE "${TPL_ROOT}/py-jsonschema-4.17.3-ykpqwsbk437l6cyducmxnvgfvqimit6n/bin/jsonschema" CACHE PATH "")
