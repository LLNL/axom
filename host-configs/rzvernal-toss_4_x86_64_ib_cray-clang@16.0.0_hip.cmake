...
if(DEFINED ENV{SPACK_CC})
  ...
  set(CMAKE_C_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_03_25_12_47_33/spack/lib/spack/env/clang/clang" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_03_25_12_47_33/spack/lib/spack/env/clang/clang++" CACHE PATH "")

  set(CMAKE_Fortran_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_03_25_12_47_33/spack/lib/spack/env/clang/flang" CACHE PATH "")
...
set(TPL_ROOT "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_03_25_12_47_33/clang-16.0.0" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.1-weyusx6lu3gczfg24vwaji4dy53ekfc5" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-fg73ebtjbsm2kpd5s44vxa6jjsybwbbb" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.6.0-rqn67zhr6wo6mgcfqjrb3kzzh4neg52v" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-iuu6knfssyy4j2uv6qo7oqmm2afqw5jv" CACHE PATH "")

set(LUA_DIR "${TPL_ROOT}/lua-5.4.4-k44ecokhewutosgyh3v4ifqejiqxxkwk" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2024.02.0-bhaizao6xxanpjtwl5btgkqauwsvgifl" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2024.02.0-6jlqi3ngybjnhvspf3rjvcjwktnjbpop" CACHE PATH "")

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-mejf7zfhnqeapizvhftucly5jsxo4hdv" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-2.10.0-fq2pmsg5voa3v3ptwp3rmm3erw5tbwgu" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2024.02.0-dhfpr57dt7c4nlugbt6n2xxpd6nnww7q" CACHE PATH "")
