...
if(DEFINED ENV{SPACK_CC})
  ...
  set(CMAKE_C_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_09_18_13_35_23/spack/lib/spack/env/clang/clang" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_09_18_13_35_23/spack/lib/spack/env/clang/clang++" CACHE PATH "")

  set(CMAKE_Fortran_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_09_18_13_35_23/spack/lib/spack/env/clang/flang" CACHE PATH "")
...
set(CMAKE_EXE_LINKER_FLAGS "-Wl,--disable-new-dtags -L/opt/rocm-5.7.1/hip/../llvm/lib -L/opt/rocm-5.7.1/hip/lib -Wl,-rpath,/opt/rocm-5.7.1/hip/../llvm/lib:/opt/rocm-5.7.1/hip/lib -lpgmath -lflang -lflangrti -lompstub -lamdhip64  -L/opt/rocm-5.7.1/hip/../lib64 -Wl,-rpath,/opt/rocm-5.7.1/hip/../lib64  -L/opt/rocm-5.7.1/hip/../lib -Wl,-rpath,/opt/rocm-5.7.1/hip/../lib -lamd_comgr -lhsa-runtime64 " CACHE STRING "")
...
set(TPL_ROOT "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_09_18_13_35_23/clang-17.0.0" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.2-tjms4wglixbo45w6hr4fa7xfajql4xnr" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-ux4kghahksxmzxs5jsqrvk5bkh3oiwmf" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.6.0-hsjurrdtqeduf7fnwaydeejqtni6475d" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-i5pmiapmep42shvad3lfssxqkbqfhxtq" CACHE PATH "")

set(LUA_DIR "${TPL_ROOT}/lua-5.4.6-nfq42mc4oigoilicrlwf5fo5evxpjcpf" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2024.07.0-d6gfb7btfdps6ftd5rlkzfnsxdyy4efe" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2024.07.0-3sjhgtx5lagkemh35bnuwwgkiurmcqte" CACHE PATH "")

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-l7apis6v3cqgjvgkkgmzvxmjswaslsrw" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-2.10.0-vcctevwu73sl3juljppsoker47zr7p7y" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2024.07.0-3sknbhelous4wu3mgeyejsojq3rcwvj2" CACHE PATH "")
