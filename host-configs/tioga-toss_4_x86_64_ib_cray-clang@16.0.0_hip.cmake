...
if(DEFINED ENV{SPACK_CC})
  ...
  set(CMAKE_C_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_09_18_15_20_11/spack/lib/spack/env/clang/clang" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_09_18_15_20_11/spack/lib/spack/env/clang/clang++" CACHE PATH "")

  set(CMAKE_Fortran_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_09_18_15_20_11/spack/lib/spack/env/clang/flang" CACHE PATH "")
...
set(CMAKE_HIP_COMPILER "/opt/rocm-5.6.0/llvm/bin/clang++" CACHE FILEPATH "")
...
set(TPL_ROOT "/usr/WS1/axom/libs/toss_4_x86_64_ib_cray/2024_09_18_15_20_11/clang-16.0.0" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.2-lndgp7ve73cwzse7savgynm76rk2yamy" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-fjossx5teajxopgkqhogkr42psd5hm6l" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.6.0-ttg36gu2kf37iwt347lrcl2iii7ugrcz" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-ooqyhbkdumnskvllubl2mnfpgsvuevek" CACHE PATH "")

set(LUA_DIR "${TPL_ROOT}/lua-5.4.6-okjvzxrxfnxm7bzvqqy76vmsrdasgjhf" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-2024.07.0-juuah6k7gt2wbptaymyuzqbllicmytey" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2024.07.0-xw3qgm3islfsa6levkedakwswdl5shde" CACHE PATH "")

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-s3p2bbs3n3bprhixwvxja5b6svk64zzm" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-2.10.0-36bghzk6q3ow43vzdkbgfiblggll3zsh" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-2024.07.0-x5y47jmwwktji5vi4p2ui3st3w7uafip" CACHE PATH "")
