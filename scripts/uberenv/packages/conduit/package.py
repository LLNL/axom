...
class Conduit(Package):
    ...
    url = "https://github.com/LLNL/conduit/releases/download/v0.5.1/conduit-v0.5.1-src-with-blt.tar.gz"

    version('0.5.1', '4aecbd4abb9d7ab8c3a16e4f28fc8871')
    ...
    variant("mpi", default=False, description="Build Conduit MPI Support")
    ...
    def install(self, spec, prefix):
        ...
        with working_dir('spack-build', create=True):
            ...
            if 'blueos_3' in os.getenv('SYS_TYPE', "") and 'xl@coral' in os.getenv('SPACK_COMPILER_SPEC', ""):
                ...
                cmake_args.append('-DENABLE_EXAMPLES=OFF')
